...
if ( ! class_exists( 'WFSPB_F_Shipping' ) ) {
    ...
    class WFSPB_F_Shipping {
         ...
         */
        function init() {
	        add_filter( 'plugin_action_links_woo-free-shipping-bar/woo-free-shipping-bar.php', array(
		        $this,
		        'settings_link',
	        ), 9 );
	    ...
	    function load_classes() {
		    ...
		    $this->settings = WFSPB_F_Data::instance();
        ...
        public function admin_enqueue_script() {
            ...
            if ( $page == 'woocommerce_free_ship' ) {
                ...
                wp_enqueue_style( 'woo-free-shipping-bar-menu', WFSPB_F_SHIPPING_CSS . 'menu.min.css', array(), WFSPB_F_VERSION );
                wp_enqueue_style( 'woo-free-shipping-bar-button', WFSPB_F_SHIPPING_CSS . 'button.min.css', array(), WFSPB_F_VERSION );
                wp_enqueue_style( 'woo-free-shipping-bar-segment', WFSPB_F_SHIPPING_CSS . 'segment.min.css', array(), WFSPB_F_VERSION );
                wp_enqueue_style( 'woo-free-shipping-bar-tab', WFSPB_F_SHIPPING_CSS . 'tab.css', array(), WFSPB_F_VERSION );
                wp_enqueue_style( 'woo-free-shipping-bar-form', WFSPB_F_SHIPPING_CSS . 'form.min.css', array(), WFSPB_F_VERSION );
                wp_enqueue_style( 'woo-free-shipping-bar-dropdown', WFSPB_F_SHIPPING_CSS . 'dropdown.min.css', array(), WFSPB_F_VERSION );
                wp_enqueue_style( 'woo-free-shipping-bar-checkbox', WFSPB_F_SHIPPING_CSS . 'checkbox.min.css', array(), WFSPB_F_VERSION );
                wp_enqueue_style( 'woo-free-shipping-bar-icon', WFSPB_F_SHIPPING_CSS . 'icon.min.css', array(), WFSPB_F_VERSION );
                wp_enqueue_style( 'woocommerce-free-shipping-font-select', WFSPB_F_SHIPPING_CSS . 'fontselect.css', array(), WFSPB_F_VERSION );
                wp_enqueue_style( 'woocommerce-free-shipping-font-transition', WFSPB_F_SHIPPING_CSS . 'transition.min.css', array(), WFSPB_F_VERSION );
                ...
                wp_enqueue_media();
                wp_enqueue_script( 'woo-free-shipping-bar-dependsOn', WFSPB_F_SHIPPING_JS . 'dependsOn.min.js', array( 'jquery' ), WFSPB_F_VERSION, true );
                wp_enqueue_script( 'woo-free-shipping-bar-tab', WFSPB_F_SHIPPING_JS . 'tab.js', array( 'jquery' ), WFSPB_F_VERSION, true );
                wp_enqueue_script( 'woo-free-shipping-bar-form', WFSPB_F_SHIPPING_JS . 'form.js', array( 'jquery' ), WFSPB_F_VERSION, true );
                wp_enqueue_script( 'woo-free-shipping-bar-dropdown', WFSPB_F_SHIPPING_JS . 'dropdown.js', array( 'jquery' ), WFSPB_F_VERSION, true );
                wp_enqueue_script( 'woo-free-shipping-bar-checkbox', WFSPB_F_SHIPPING_JS . 'checkbox.min.js', array( 'jquery' ), WFSPB_F_VERSION, true );
                wp_enqueue_script( 'woo-free-shipping-bar-font-select', WFSPB_F_SHIPPING_JS . 'fontselect.js', array( 'jquery' ), WFSPB_F_VERSION, true );
                wp_enqueue_script( 'woo-free-shipping-bar-transition', WFSPB_F_SHIPPING_JS . 'transition.min.js', array( 'jquery' ), WFSPB_F_VERSION, true );
                wp_enqueue_script( 'woo-free-shipping-bar-jqColorPicker', WFSPB_F_SHIPPING_JS . 'jqColorPicker.min.js', array( 'jquery' ), WFSPB_F_VERSION, true );
                wp_enqueue_script( 'woo-free-shipping-bar-address', WFSPB_F_SHIPPING_JS . 'address-1.6.min.js', array( 'jquery' ), WFSPB_F_VERSION, true );
                wp_enqueue_script( 'woo-free-shipping-bar-admin', WFSPB_F_SHIPPING_JS . 'woo-free-shipping-bar-admin.js', array( 'jquery' ), WFSPB_F_VERSION, true );
        ...
        public function get_field( $field, $default = '' ) {
            return $this->settings->get_option( $field, $default);
        }
        ...
        public function save_data() {
            ...
            $this->settings                     = WFSPB_F_Data::instance( true );
        }
                ...
                <div class="woo-free-shipping-bar">
                    ...
                    <form class="vi-ui form" method="post" action="">
                                ...
                                <tr valign="top">
                                    ...
                                    <td>
                                        <div class="vi-ui toggle checkbox checked">
                                            <input type="checkbox"
                                                   name="<?php echo esc_attr( self::set_field( 'enable' ) ); ?>" <?php checked( $this->get_field( 'enable' ), 1 ); ?>
                                                   value="1">
                                ...
                                <tr valign="top">
                                    ...
                                    <td>
                                        <select class="vi-ui fluid dropdown required"
                                                ...
                                                value="<?php echo esc_attr( $this->get_field( 'default-zone' ) ); ?>">
                        ...
                        <div class="vi-ui wfspb-container tab attached bottom segment" data-tab="design">
                            <table class="optiontable form-table">
                                ...
                                <tr valign="top">
                                    ...
                                    <td>
                                        <input type="text"
                                               ...
                                               value="<?php echo esc_attr( $this->get_field( 'bg-color', 'rgb(32, 98, 150)' ) ); ?>">
                                    </td>
                                </tr>
                                <tr valign="top">
                                    ...
                                    <td>
                                        <input type="text"
                                               ...
                                               value="<?php echo esc_attr( $this->get_field( 'text-color', '#FFFFFF' ) ); ?>">
                                    </td>
                                </tr>
                                <tr valign="top">
                                    ...
                                    <td>
                                        <input type="text"
                                               ...
                                               value="<?php echo esc_attr( $this->get_field( 'link-color', '#77B508' ) ); ?>">
                                    </td>
                                </tr>
                                <tr valign="top">
                                    ...
                                    <td>
                                        <input id="wfspb-font" type="text"
                                               ...
                                               value="<?php echo esc_attr( $this->get_field( 'font', 'PT Sans' ) ); ?>">
                                    </td>
                                </tr>
                                <tr valign="top">
                                    ...
                                    <td>
                                        <select class="vi-ui fluid dropdown select-fontsize"
                                            ...
                                            <?php for ( $i = 10; $i <= 40; $i ++ ) { ?>
                                                <option value="<?php echo esc_attr( $i ); ?>" <?php selected( $this->get_field( 'font-size', 16 ), $i ); ?> > <?php echo esc_html( $i ) . 'px'; ?></option>
                                            <?php } ?>
                                        </select>
                                    </td>
                                </tr>
                                <tr valign="top">
                                    ...
                                    <td>
                                        <select class="vi-ui fluid dropdown select-textalign"
                                            ...
                                            <option value="left" <?php selected( $this->get_field( 'text-align' ), 'left' ) ?>><?php esc_html_e( 'Left', 'woo-free-shipping-bar' ) ?></option>
                                            <option value="center" <?php selected( $this->get_field( 'text-align', 'center' ), 'center' ) ?>><?php esc_html_e( 'Center', 'woo-free-shipping-bar' ) ?></option>
                                        </select>
                                    </td>
                                </tr>
                                <tr valign="top">
                                    ...
                                    <td>
                                        <div class="vi-ui toggle checkbox wfspb-enable-progress">
                                            <input type="checkbox"
                                                   name="<?php echo esc_attr( self::set_field( 'enable-progress' ) ); ?>" <?php checked( $this->get_field( 'enable-progress' ), 1 ); ?>
                                                   value="1">
                                ...
                                <tr valign="top" class="wfspb-progress-percent">
                                    ...
                                    <td>
                                        <input type="text"
                                               ...
                                               value="<?php echo esc_attr( $this->get_field( 'bg-color-progress', '#C9CFD4' ) ); ?>">
                                    </td>
                                </tr>
                                <tr valign="top" class="wfspb-progress-percent">
                                    ...
                                    <td>
                                        <input type="text"
                                               ...
                                               value="<?php echo esc_attr( $this->get_field( 'bg-current-progress', '#0D47A1' ) ); ?>">
                                    </td>
                                </tr>
                                <tr valign="top" class="wfspb-progress-percent">
                                    ...
                                    <td>
                                        <input type="text"
                                               ...
                                               value="<?php echo esc_attr( $this->get_field( 'progress-text-color', '#FFFFFF' ) ); ?>">
                                    </td>
                                </tr>
                                <tr valign="top" class="wfspb-progress-percent">
                                    ...
                                    <td>
                                        <select class="vi-ui fluid dropdown select-fontsize-progress"
                                            ...
                                            <?php for ( $i = 10; $i <= 20; $i ++ ) { ?>
                                                <option value="<?php echo esc_attr( $i ); ?>" <?php selected( $this->get_field( 'font-size-progress', 11 ), $i ); ?> > <?php echo esc_html( $i ) . 'px'; ?></option>
                                            <?php } ?>
                                        </select>
                                    </td>
                                </tr>
                                <tr valign="top" class="wfspb-progress-percent">
                                    ...
                                    <td>
                                        <select class="vi-ui fluid dropdown select-progress-effect"
                                            ...
                                            <option value="0" <?php selected( $this->get_field( 'progress_effect', 0 ), 0 ); ?>><?php esc_html_e( 'Plain', 'woo-free-shipping-bar' ) ?></option>
                                            <option value="1" <?php selected( $this->get_field( 'progress_effect' ), 1 ); ?>><?php esc_html_e( 'Loading', 'woo-free-shipping-bar' ) ?></option>
                                            <option value="2" <?php selected( $this->get_field( 'progress_effect' ), 2 ); ?>><?php esc_html_e( 'Border', 'woo-free-shipping-bar' ) ?></option>
                                    ...
                                    <td>
                                        <div class="vi-ui form">
                                            <div class="three fields">
                                                <div class="field">
                                                    <img src="<?php echo esc_url( WFSPB_F_SHIPPING_IMAGES ) ?>progress-style1.png"
                                                         class="vi-ui centered medium image middle aligned"/>
                                                    <div class="vi-ui toggle checkbox checked center aligned segment">
                                                        <input type="radio"
                                                               name="<?php echo esc_attr( self::set_field( 'style' ) ); ?>" <?php checked( $this->get_field( 'style', 1 ), 1 ); ?>
                                                               value="1">
                                                        <label for="<?php echo esc_attr( self::set_field( 'style' ) ); ?>"><?php esc_html_e( 'Style 1', 'woo-free-shipping-bar' ) ?></label>
                                                    </div>
                                                </div>
                                                <div class="field">
                                                    <img src="<?php echo esc_url( WFSPB_F_SHIPPING_IMAGES ) ?>progress-style2.png"
                                                         class="vi-ui centered medium image middle aligned"/>
                                                    <div class="vi-ui toggle checkbox checked center aligned segment">
                                                        <input type="radio"
                                                               name="<?php echo esc_attr( self::set_field( 'style' ) ); ?>" <?php checked( $this->get_field( 'style' ), 2 ); ?>
                                                               value="2">
                                                        <label for="<?php echo esc_attr( self::set_field( 'style' ) ); ?>"><?php esc_html_e( 'Style 2', 'woo-free-shipping-bar' ) ?></label>
                                                    </div>
                                                </div>
                                                <div class="field">
                                                    <img src="<?php echo esc_url( WFSPB_F_SHIPPING_IMAGES ) ?>progress-style3.png"
                                                         class="vi-ui centered medium image middle aligned"/>
                                                    <div class="vi-ui toggle checkbox checked center aligned segment">
                                                        <input type="radio"
                                                               name="<?php echo esc_attr( self::set_field( 'style' ) ); ?>" <?php checked( $this->get_field( 'style' ), 3 ); ?>
                                                               value="3">
                                ...
                                <tr valign="top">
                                    ...
                                    <td>
                                        <div class="vi-ui form">
                                            <div class="three fields">
                                                <div class="field">
                                                    <img src="<?php echo esc_url( WFSPB_F_SHIPPING_IMAGES ) ?>position-top.png"
                                                         class="vi-ui centered large image middle aligned "/>
                                                    <div class="vi-ui toggle checkbox checked center aligned segment">
                                                        <input type="radio"
                                                               name="<?php echo esc_attr( self::set_field( 'position' ) ); ?>" <?php checked( $this->get_field( 'position', 0 ), 0 ); ?>
                                                               value="0">
                                                        <label for="<?php echo esc_attr( self::set_field( 'position' ) ); ?>"><?php esc_html_e( 'Top', 'woo-free-shipping-bar' ) ?></label>
                                                    </div>
                                                </div>
                                                <div class="field">
                                                    <img src="<?php echo esc_url( WFSPB_F_SHIPPING_IMAGES ) ?>position-bottom.png"
                                                         class="vi-ui centered large image middle aligned "/>
                                                    <div class="vi-ui toggle checkbox center aligned segment">
                                                        <input type="radio"
                                                               name="<?php echo esc_attr( self::set_field( 'position' ) ); ?>" <?php checked( $this->get_field( 'position' ), 1 ); ?>
                                                               value="1">
                                ...
                                <tr valign="top">
                                    ...
                                    <td>
                                        <textarea
                                            name="<?php echo esc_attr( self::set_field( 'custom_css' ) ); ?>"><?php echo esc_attr( $this->get_field( 'custom_css' ) ) ?></textarea>
                                    </td>
                                </tr>
                            </table>
                            <?php
                            if ( $this->get_field( 'position' ) == 0 ) {
                                $class_pos = 'top_bar';
                            } else {
                                $class_pos = 'bottom_bar';
                            }
                            
                            if ( $this->get_field( 'enable-progress' ) == 0 ) {
                        ...
                        <div class="vi-ui wfspb-container tab attached bottom segment" data-tab="message">
                            <?php
                            $langs = array( 'default' => array( 'native_name' => '', 'country_flag_url' => '' ) );
                                ...
                                <tr valign="top">
                                    ...
                                    <td class="wfspb-notice-sample">
                                        ...
                                        foreach ( $langs as $lang_code => $lang_opttion ) {
                                            ...
                                            <textarea rows="2"
                                                      name="<?php echo esc_attr( self::set_field( 'announce-system' ) . '[' . esc_attr( $lang_code ) . ']' ); ?>"><?php echo wp_kses_post( trim( wp_strip_all_tags( self::get_message_field( 'announce-system', $lang_code, 'Free shipping for billing over {min_amount}' ) ) ) ); ?></textarea>
                                            <?php
                                        } ?>
                                    ...
                                    <td class="wfspb-notice-sample">
                                        <div class="field">
                                            ...
                                            foreach ( $langs as $lang_code => $lang_opttion ) {
                                                ...
                                                <textarea rows="2"
                                                          name="<?php echo esc_attr( self::set_field( 'message-purchased' ) . '[' . esc_attr( $lang_code ) . ']' ); ?>"><?php echo wp_kses_post( trim( wp_strip_all_tags( self::get_message_field( 'message-purchased', $lang_code, 'You have purchased {total_amounts} of {min_amount}' ) ) ) ); ?></textarea>
                                                <?php
                                            } ?>
                                            <ul class="description" style="list-style: none">
                                                <li>
                                ...
                                <tr valign="top">
                                    ...
                                    <td class="wfspb-notice-sample">
                                        ...
                                        foreach ( $langs as $lang_code => $lang_opttion ) {
                                            ...
                                            <textarea rows="2"
                                                      name="<?php echo esc_attr( self::set_field( 'message-success' ) . '[' . esc_attr( $lang_code ) . ']' ); ?>"><?php echo wp_kses_post( trim( wp_strip_all_tags( self::get_message_field( 'message-success', $lang_code, 'Congratulation! You have got free shipping. Go to {checkout_page}' ) ) ) ); ?></textarea>
                                            <?php
                                        } ?>
                                        <ul class="description" style="list-style: none">
                                            <li>
                                ...
                                <tr valign="top">
                                    ...
                                    <td class="wfspb-notice-sample">
                                        ...
                                        foreach ( $langs as $lang_code => $lang_opttion ) {
                                            ...
                                            <textarea rows="2"
                                                      name="<?php echo esc_attr( self::set_field( 'message-error' ) . '[' . esc_attr( $lang_code ) . ']' ); ?>"><?php echo wp_kses_post( trim( wp_strip_all_tags( self::get_message_field( 'message-error', $lang_code, 'You are missing {missing_amount} to get Free Shipping. Continue {shopping}' ) ) ) ); ?></textarea>
                                            <?php
                                        } ?>
                                        <ul class="description" style="list-style: none">
                                            <li>
                                    ...
                                    <td>
                                        <div class="vi-ui toggle checkbox checked">
                                            <input type="hidden"
                                                   ...
                                                   value="0"/>
                                            <input type="checkbox"
                                                   name="<?php echo esc_attr( self::set_field( 'show-giftbox' ) ); ?>" <?php checked( $this->get_field( 'show-giftbox', 1 ), 1 ); ?>
                                                   value="1"/>
        ...
        public function create_options_page() {
            add_menu_page( esc_html__( 'Free Shipping Bar for WooCommerce', 'woo-free-shipping-bar' ), esc_html__( 'WC F-Shipping Bar', 'woo-free-shipping-bar' ), 'manage_options', 'woocommerce_free_ship', array( $this, 'setting_page_woo_free_shipping_bar' ), 'dashicons-backup', 2 );
        }
        ...
        public function get_data_atc() {
            ...
            if ( $country ) {
                ...
                $min_amount       = isset( $detect_result['min_amount'] ) ? $detect_result['min_amount'] : '';
                $ignore_discounts = isset( $detect_result['ignore_discounts'] ) ? $detect_result['ignore_discounts']: '';
            ...
            if ( $total >= $min_amount ) {
                ...
                if ( $min_amount == 0 ) {
                    ...
                    $amount_total_pr = round( ( $total * 100 ) / $min_amount, wc_get_price_decimals() );
                }
            }
            ...
            if ( $total < $min_amount ) {
                $message = str_replace( $key, $replaced, wp_strip_all_tags( $message_purchased ) );
            } else {
                $message = str_replace( '{checkout_page}', $checkout, wp_strip_all_tags( $message_success ) );
            }
                ...
                if ( is_array( $shipping_methods ) && count( $shipping_methods ) ) {
                    foreach ( $shipping_methods as $free_shipping ) {
                        if ( $free_shipping->id == 'free_shipping' ) {
                            ...
                            printf("<option value='" . esc_attr( $zone_id ) . "' " . selected( $this->get_field( 'default-zone', $zone_id ), $zone_id ) . " >" . esc_html( $zone_name ) . "</option>" );
                        } else {
                            echo '';
                        }
                    }
